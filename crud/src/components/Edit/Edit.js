                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <div className="w-full md:full px-3">
                    ...
                    <input
                      ...
                      type="text"
                      value={name}
                      onChange={(e) => {setName(e.target.value); user[0].name = e.target.value}}
                    />
                  </div>
                  <div className="w-full md:full px-3">
                    <label
                    ...
                    <input
                      ...
                      type="text"
                      value={position}
                      onChange={(e) => {setPosition(e.target.value); user[0].position= e.target.value}}
                    />
                  </div>
                  <div className="w-full md:full px-3">
                    <label
                    ...
                    <input
                      ...
                      type="number"
                      value={salary}
                      onChange={(e) => { setSalary(e.target.value); user[0].salary= e.target.value}}
                    />
                  </div>
                  {/*footer*/}
